...
AOSP_VERSION := 9.0
LITE_VERSION_CODENAME := PIE
LITE_VERSION_LEVEL := v10
LITE_VERSION_SUBLEVEL := 0
LITE_VERSION := $(LITE_VERSION_LEVEL).$(LITE_VERSION_SUBLEVEL)
...
# Output zip naming
ifeq ($(LITE_RELEASE),true)
LITE_MOD_VERSION := LiteOS-$(LITE_VERSION)$(LITE_POSTFIX)-$(LITE_BUILD)-$(LITE_BUILD_TYPE)-$(LITE_VERSION_CODENAME)
else
LITE_MOD_VERSION := LiteOS-$(LITE_VERSION)-$(LITE_BUILD_TYPE)-$(LITE_BUILD)$(LITE_POSTFIX)
endif

ZIP_OUT_NAME := $(LITE_MOD_VERSION)
